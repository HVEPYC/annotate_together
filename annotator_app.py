# Annotator App generated by Gemini 2.5 Pro with prompts by Harishankar Vinod and Team
# ====================================================================================
...
def load_existing_annotations():
    ...
    if os.path.exists(filepath):
        try:
            ...
            image_ids_seen_overall = set() # Track across all files
...
def new_annotation_entry_callback():
    ...
    new_entry_data = {
        ...
        "tags": [], "bbox": [],
        "metadata": { "license": "CC-BY", "annotator_id": annotator_id_value,
...
# TODO:
# Add the ability to track every image that has ever been annotated using this app, possibly like a sha256 or something made for this app
